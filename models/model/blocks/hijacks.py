...
from models.model.blocks.hooks import IHook
from models.model.blocks.hooks import IBasicHook
from models.model.blocks.hooks import IAttentionHook
from models.model.blocks.hooks import MultiHooks
from models.model.blocks.customs import Linear
...
class LoRAManager:
    ...
    def load_pack_with(self, key: str, d: tensor_dict_type) -> None:
        ...
        if num_source == num_prepared:
            print(f"{num_prepared} weights are loaded")
        else:
            print(
    ...
    def inject(self, m: nn.Module, *keys: str) -> None:
        ...
        if num_hooks == num_injected:
            print(f"{num_injected} hooks are injected")
        else:
            print(
